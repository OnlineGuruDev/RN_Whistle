...
class AppleiMessage extends PureComponent {
  render() {
      ...
      <View style={[styles.container, inbound ? styles.inbound : styles.outbound]}>
        ...
        <View style={styles.messageContainer}>
          ...
          <View style={inbound ? styles.inboundSubtitle : styles.outboundSubtitle}>
            <Icon style={[styles.subtitle, styles.subtitleIcon]} name="apple" size={18} />
...
const styles = StyleSheet.create({
  ...
  outboundTextBox: {
    backgroundColor: COLORS.IMESSAGE_LIGHT,
    borderRadius: 15,
  ...
  inboundTextBox: {
    ...
    borderColor: COLORS.IMESSAGE_LIGHT,
    borderWidth: 2,
    padding: 10,
  },
  outboundFont: {
